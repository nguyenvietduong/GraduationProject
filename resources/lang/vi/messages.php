...
return [
    'system' => [
        ...
        'alert' => [
            ...
            'success' => 'Thành công! Nhiệm vụ đã hoàn thành.',
            'error' => [
                'title' => 'Lỗi...',
                'text' => 'Đã xảy ra lỗi!',
            ],
        ...
        'notification' => [
            'login' => [
                ...
                'errorNotLogin' => 'Bạn cần đăng nhập để truy cập trang này.',
            ],
            'logout' => [
        ...
        'buttonPermission' => 'Cấp quyền',
        'titleNotificationReservation' => 'Có đơn đặt bàn mới',
    ],
    ...
    'reservation' => [
        ...
        'fields' => [
            ...
            'date' => 'Ngày',
            'time' => 'Giờ',
            'reservation_time' => 'Thời gian đặt chỗ',
            'phone_placeholder' => 'Nhập số điện thoại',
            'guests' => 'Số người',
            'guests_placeholder' => 'Nhập số người',
            'special_request' => 'Ghi chú',
            'special_request_placeholder' => 'Nhập ghi chú',
            'reservation_information' => 'Thông tin người đặt bàn',
            'dish' => 'Món ăn'
        ],
