                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-lg-5">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <h5 for="" id="">Tổng hóa đơn : <span for="" id="total_amount"></span> VNĐ</h5>
                                    <h5 for="" id="">Giảm giá : <span for="" id="voucher">0</span> VNĐ</h5>
                                    <h5 for="" id="">Tổng thanh toán : <span for="" id="total_payment">0</span> VNĐ</h5>
                                    <hr>
                                    <label for="">Nhập mã giảm giá</label>
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            <input id="input_voucher" type="text" class="form-control " placeholder="Nhập mã giảm giá"
                                            value="">
                                    ...
                                    <button class="btn btn-primary py-2 px-3 mx-1 mt-3" id="btn_paid">Đã thanh toán</button>
                                    <button class="btn btn-warning py-2 px-3 mx-1 mt-3">Xuất hóa đơn</button>
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div>
                    </div>
