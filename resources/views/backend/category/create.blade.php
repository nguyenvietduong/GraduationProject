                    ...
                    <div class="card-body p-0">
                        <div class="row g-0 h-100">
                            ...
                            <div class="col-lg-12 border-end">
                                <h4 class="card-title fs-16 mb-0 pt-3 ps-4">{{ $config['seo']['create']['title'] }}</h4>

                                <form id="myForm" class="p-4 pt-3" action="{{ route('admin.category.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-12 mb-2 mb-lg-1">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ old('name') }}" onkeyup="generateSlug('name', 'slug')"
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        <button type="button" class="btn btn-primary me-2"
                                            onclick="confirmAndSubmit('myForm')">Create</button>
