<div class="col-6 container">
    ...
    <div class="row">
        <div class="col-12 col-md mb-2">
            <div class="row">
                <div class="col-4">
                    <label for="start_price">{{__("messages.menu.filters.start_price")}}</label> <!-- Thêm id cho label -->
                </div>
                <div class="col-8">
        ...
        <div class="col-12 col-md mb-2">
            <div class="row">
                <div class="col-4">
                    <label for="end_price">{{__("messages.menu.filters.end_price")}}</label> <!-- Thêm id cho label -->
                </div>
                <div class="col-8">
