...
@section('contentUser')
<!-- Start Hero -->
@include('frontend.component.breadcrumb', [($titleHeader = 'Reservation'), ($title = 'Reservation')])
<!-- End Hero -->
                ...
                <form>
                    <div class="grid md:grid-cols-2 gap-4 mt-6">
                        ...
                        <div>
                            ...
                            <input name="input-time" type="text" id="input-time"
                                class="mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0"
                                placeholder="(ex: 8:00 p.m)" readonly>
                        </div>
                    </div><!--end grid-->
